...
defmodule Day4Test do
  ...
  test "run" do
    expected = [
      ...
      %Info{date: DateHelper.create_date_time(1518, 11, 04, 00, 02), action: "Guard #99 begins shift"},
      ...
      %Info{date: DateHelper.create_date_time(1518, 11, 03, 00, 05), action: "Guard #10 begins shift"},
      %Info{date: DateHelper.create_date_time(1518, 11, 03, 00, 24), action: "falls asleep"},
      %Info{date: DateHelper.create_date_time(1518, 11, 01, 00, 00), action: "Guard #10 begins shift"},
      %Info{date: DateHelper.create_date_time(1518, 11, 05, 00, 55), action: "wakes up"},
      %Info{date: DateHelper.create_date_time(1518, 11, 01, 00, 25), action: "wakes up"},
      %Info{date: DateHelper.create_date_time(1518, 11, 05, 00, 03), action: "Guard #99 begins shift"},
      %Info{date: DateHelper.create_date_time(1518, 11, 04, 00, 36), action: "falls asleep"},
      %Info{date: DateHelper.create_date_time(1518, 11, 01, 00, 05), action: "falls asleep"},
      %Info{date: DateHelper.create_date_time(1518, 11, 03, 00, 29), action: "wakes up"},
      %Info{date: DateHelper.create_date_time(1518, 11, 05, 00, 45), action: "falls asleep"},
    ]
